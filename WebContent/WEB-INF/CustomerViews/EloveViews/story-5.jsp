...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn"%>
    <div class="container-fulid">
      <img src="img/elove/story_title_5.jpg" class="img-responsive title" alt="title background"/>
    </div><!-- title -->
    ...
    <div class="content-bg">
      <div class="container-fulid">
        <img src="img/elove/story_meetyou_5.jpg" class="img-responsive center-block"/>
