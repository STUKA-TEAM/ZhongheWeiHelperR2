...
<html lang="en">
  ...
  <body>
    ...
    <div class="sidebar-guide" onclick="sidebar_up()">
      <img src="img/elove/sidebar_guide_7.png" class="sidebar-guide-logo"/>
    ...
    <div id="sidebar_list" class="sidebar hidden" state="down">
      <div id="audio" class="audio" onclick="audio_switch(7)">
        <input type="hidden" id="musicPath" value="${elove.music}"/>
        <img src="img/elove/audio_on_7.png" class="audio-logo"/>
        <p id="audio-p">音效开启</p>
