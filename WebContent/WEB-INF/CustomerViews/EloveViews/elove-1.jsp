    ...
    <div id="wrapper" class="top-nav">
      <div id="scroller" class="top-navbar">
        ...
        <div id="story" class="top-nav-item pull-left active">
          <a href="javascript:void(0)"><img src="img/elove/encount_logo_1.png" class="nav-logo"/>相知相遇</a>
        </div>
        <div id="dress" class="top-nav-item pull-left">
          <a href="javascript:void(0)"><img src="img/elove/photo_logo_1.png" class="nav-logo"/>婚纱剪影</a>
        </div>
        <div id="info" class="top-nav-item pull-left">
          <a href="javascript:void(0)"><img src="img/elove/info_logo_1.png" class="nav-logo"/>婚礼信息</a>
        </div>
        <c:if test="${recordImages.size()!=0}">
        <div id="record" class="top-nav-item pull-left">
          <a href="javascript:void(0)"><img src="img/elove/record_logo_1.png" class="nav-logo"/>婚礼记录</a>
        </div>
        </c:if>
        <div id="viewAccount" class="top-nav-item pull-left">
          <a href="javascript:void(0)" onclick="switch_guide('#account_guide_bg','#account_guide_img')"><img src="img/elove/viewAcc_logo_1.png" class="nav-logo"/>关注账号</a>
        </div>
        <div id="intro" class="top-nav-item pull-left">
          <a href="customer/elove/intro?eloveid=${elove.eloveid}"><img src="img/elove/intr_logo_1.png" class="nav-logo"/>${elove.sideCorpInfo}</a>
        </div>
      </div>
    </div>
