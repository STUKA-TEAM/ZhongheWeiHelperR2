            ...
            <div class="panel panel-info col-md-10 col-md-offset-1">
              ...
              <div class="panel-body">
                <div  class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <select id="roleid" class="form-control">
                        ...
                        <option value="${item.roleid}">${item.roleLabel}</option>
                        </c:forEach>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="branch_pwd" class="col-md-3 control-label">密码</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control" id="password" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="branch_pwd_confirm" class="col-md-3 control-label">确认密码</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control" id="passwordConfirm" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="row">
                  <a class="btn btn-info col-md-2 col-md-offset-3 text-center" onclick="submitItem('insert')">创建分店</a>
