              ...
              <div class="panel-body">
                <div  class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <input type="text" class="form-control" id="price" placeholder="本菜品的价格（数字）" value="${dish.price}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="dishUnit" class="col-md-3 control-label">价格单位</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control" id="dishUnit" placeholder="本菜品的单位（如：例，个，瓶）" value="${dish.dishUnit}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="recomNum" class="col-md-3 control-label">初始推荐数</label>
                    <div class="col-md-7">
                      <input type="text" class="form-control" id="recomNum" placeholder="手机上看到的本菜品的推荐数的初始值" value="${dish.recomNum}">
                    </div>
                  </div>
	                <div class="form-group">
